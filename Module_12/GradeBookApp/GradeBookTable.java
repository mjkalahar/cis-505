    ...
    private TableColumn<Student, String> createTableColumn(String columnName, String propertyName) {
        ...
        column.setOnEditCommit(event -> {
            ...
            if(propertyName.equals("firstName") || propertyName.equals("lastName")) {
                isValid = GradeBookValidator.isValidName(newValue);
            }
            if(propertyName.equals("course")) {
                isValid = GradeBookValidator.isValidCourse(newValue);
            }
            if(!isValid) {
                event.consume();
                return;
            ...
            switch (propertyName) {
                case "firstName" -> student.setFirstName(event.getNewValue());
                case "lastName" -> student.setLastName(event.getNewValue());
                case "course" -> student.setCourse(event.getNewValue());
            }
        });
