...
public class Student {
     ...
     * Creates a new Student object with the same values as the provided Student object.
     *
     * @param student The Student object to copy.
     */
    public Student(Student student) {
        this(student.getFirstName(), student.getLastName(), student.getCourse(), student.getGrade());
    }
    ...
    /**
     * Equals override
     * Must match last name, first name, course, and grade
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(lastName.get(), student.lastName.get()) &&
                Objects.equals(firstName.get(), student.firstName.get()) &&
                Objects.equals(course.get(), student.course.get()) &&
                Objects.equals(grade.get(), student.grade.get());
    }

    /**
     * hashCode override
     * @return int hashcode of last name, first name, course, and grade
     */
    @Override
    public int hashCode() {
        return Objects.hash(lastName.get(), firstName.get(), course.get(), grade.get());
    }
}
